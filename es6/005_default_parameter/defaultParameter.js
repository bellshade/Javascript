...
console.log(jualBuah("semangka", "1 kg")); // Output : Buah semangka dengan berat 1 kg, di pasar seharga undifined.
console.log(jualBuah()); // Output : Buah undifiend dengan berat undifiend, di pasar seharga undifined.
...
* - Bagaimana jika argument tersebut tidak kita isi?
  Apabila kita tidak memberikan argument pada sebuah parameter, maka argument tersebut akan memberikan nilai default, yaitu "undifiend".  
