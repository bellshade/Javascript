...
input.addEventListener("input", function (e) { //memberikkan aksi ketika input di beri input
...
isian.addEventListener("input", function (e) {//memberikkan aksi ketika input di beri value oleh user
...
inputText.addEventListener("input", function (e) {// memberikan aksi ketika memasukkan value atau mengetik sesuatu
...
rounded.addEventListener("input", function (e) { //memberian akksi etia user mengetik angka pada input tipe number
