/**
 * Mengonversi string dari satu basis ke basis lainnya
 * @param {string} stringInBaseOne String di basis input
 * @param {string} baseOneCharacters Set karakter untuk basis input
 * @param {string} baseTwoCharacters Set karakter untuk basis output
 * @returns {string}
 */
